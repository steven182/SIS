...
public static void send(String para,String sujeto,String mensaje, String Nm) throws UnsupportedEncodingException{
final String user = "rromero.rsrg@gmail.com"; //cambiará en consecuencia al servidor utilizado
final String pass= "Steven182.44";
String nuevoMensaje="<h1 style=\"font-size: 20px; color:#009ed6; font-weight: bold; text-transform: uppercase ; \">Servicio Asignado" + "</h1>" + "<img src='https://http2.mlstatic.com/impresora-multifuncion-ricoh-D_NQ_NP_982705-MLA20871487974_092016-F.jpg'/ style=\"float: left; height: 80px; width: 100px;\"><p>" +mensaje+ "<br>\n"
                    + "<p> \n"
